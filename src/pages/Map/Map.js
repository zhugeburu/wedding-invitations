...
export default class Map extends Component {
    ...
    componentDidMount() {
        ...
        map.centerAndZoom(new BMap.Point(110.46115, 34.963216), 14);  // 初始化地图,设置中心点坐标和地图级别
        ...
        /*地图上的小狐心*/
        var pt = new BMap.Point(110.46115, 34.963216);
        ...
        infoWindow.open(new BMap.Point(110.46115, 34.963216));
    }
